...
public static class DataService
{
	...
	public static IServiceCollection UseGoDungeonEquipmentGenerated(this IServiceCollection collection)
	{
		...
		collection
			...
			//.AddTransient<IArmorViewModel, ArmorViewModel>()
			//.AddTransient<ICoinsViewModel, CoinsViewModel>()
			//.AddTransient<IMountsandvehiclesViewModel, MountsandvehiclesViewModel>()
			//.AddTransient<IToolsViewModel, ToolsViewModel>()
			//.AddTransient<ITradegoodsViewModel, TradegoodsViewModel>()
			//.AddTransient<IWeaponsViewModel, WeaponsViewModel>()
		;
		return collection;
	}
}
