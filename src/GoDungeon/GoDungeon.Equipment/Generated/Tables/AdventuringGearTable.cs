		...
		if (Table == null || Table.Count == 0)
		{
			Table = new ObservableCollection<IGameTableEntry>()
			{
				...
				new AdventuringGearTableEntryViewModel
				{
					...
					ProperName = "Barrel",
					Cost = new CostViewModel("2 gp"),
					Weight = new WeightViewModel("70 lb."),
				},
				#endregion
				...
				new AdventuringGearTableEntryViewModel
				{
					...
					Cost = new CostViewModel("5 gp"),
					Weight = new WeightViewModel("1/2 lb."),
				},
				#endregion
				...
				new AdventuringGearTableEntryViewModel
				{
					...
					Weight = new WeightViewModel("35 lb."),
				},
				#endregion
				...
				new AdventuringGearTableEntryViewModel
				{
					...
					ProperName = "Spyglass",
					Cost = new CostViewModel("1,000 gp"),
					Weight = new WeightViewModel("1 lb."),
				},
				#endregion
				...
				new AdventuringGearTableEntryViewModel
				{
					...
					Cost = new CostViewModel("2 sp"),
					Weight = new WeightViewModel("5 lb. (full)"),
				},
				#endregion
