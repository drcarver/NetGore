	...
	public override void InitializeTable()
	{
		if (Table == null || Table.Count == 0)
		{
			Table = new ObservableCollection<IGameTableEntry>()
			{
				...
				{
					Name = nameof(StandardExchangeRatesEnum.Coppercp),
					ProperName = "Copper (cp)",
					CP = Convert.ToInt32(1),
					SP = "1/10",
					EP = "1/50",
					GP = "1/100",
					PP = "1/1,000",
				...
				new StandardExchangeRatesTableEntryViewModel
				{
					Name = nameof(StandardExchangeRatesEnum.Silversp),
					ProperName = "Silver (sp)",
					CP = Convert.ToInt32(10),
					SP = "1",
					EP = "1/5",
					GP = "1/10",
					PP = "1/100",
				...
				new StandardExchangeRatesTableEntryViewModel
				{
					Name = nameof(StandardExchangeRatesEnum.Electrumep),
					ProperName = "Electrum (ep)",
					CP = Convert.ToInt32(50),
					SP = "5",
					EP = "1",
					GP = "1/2",
					PP = "1/20",
				...
				new StandardExchangeRatesTableEntryViewModel
				{
					Name = nameof(StandardExchangeRatesEnum.Goldgp),
					ProperName = "Gold (gp)",
					CP = Convert.ToInt32(100),
					SP = "10",
					EP = "2",
					GP = "1",
					PP = "1/10",
				...
				new StandardExchangeRatesTableEntryViewModel
				{
					Name = nameof(StandardExchangeRatesEnum.Platinumpp),
					ProperName = "Platinum (pp)",
					CP = Convert.ToInt32(1000),
					SP = "100",
					EP = "20",
					GP = "10",
					PP = "1",
