	...
	public override void InitializeTable()
	{
		if (Table == null || Table.Count == 0)
		{
			Table = new ObservableCollection<IGameTableEntry>()
			{
				...
				{
					Name = nameof(DruidicfocusEnum.Sprigofmistletoe),
				...
				new DruidicfocusTableEntryViewModel
				{
					Name = nameof(DruidicfocusEnum.Totem),
					ProperName = "Totem",
					Cost = new CostViewModel("1 gp"),
					Weight = new WeightViewModel("-"),
				},
				...
				new DruidicfocusTableEntryViewModel
				{
					Name = nameof(DruidicfocusEnum.Woodenstaff),
				...
				new DruidicfocusTableEntryViewModel
				{
					Name = nameof(DruidicfocusEnum.Yewwand),
					ProperName = "Yew wand",
