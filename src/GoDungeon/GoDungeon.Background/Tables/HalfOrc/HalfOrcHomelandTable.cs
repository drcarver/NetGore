...
namespace GoDungeon.Background.Tables.HalfOrc
{
    ...
    /// The homeland table
    /// </summary>
    public class HalfOrcHomelandTable : RandomTable, IHalfOrcHomelandTable
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public HalfOrcHomelandTable()
        {
            DiceSides = 100;
            Name = nameof(HalfOrcHomelandTable);
            ProperName = "HalfOrc Homeland Table";
