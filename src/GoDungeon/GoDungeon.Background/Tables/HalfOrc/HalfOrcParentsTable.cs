...
{
    public class HalfOrcParentsTable : RandomTable, IHalfOrcParentsTable
    {
        /// <summary>
        /// The parents table
        /// </summary>
        public HalfOrcParentsTable()
        {
            DiceSides = 100;
            Name = nameof(HalfOrcParentsTable);
            ProperName = "HalfOrc parents table";
