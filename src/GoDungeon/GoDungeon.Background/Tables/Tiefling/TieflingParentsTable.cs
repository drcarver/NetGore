...
{
    public class TieflingParentsTable : RandomTable, ITieflingParentsTable
    {
        /// <summary>
        /// The parents table
        /// </summary>
        public TieflingParentsTable()
        {
            DiceSides = 100;
            Name = nameof(TieflingParentsTable);
            ProperName = "Tiefling parents table";
