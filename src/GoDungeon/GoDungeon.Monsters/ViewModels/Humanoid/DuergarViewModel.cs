...
{
    public class DuergarViewModel : CreatureViewModel, ICreature
    {
        /// <summary>
        /// Constructor
        /// </summary>
            ...
            base(services, loggerFactory)
        {
            ...
            ArmorClass = new ArmorClassViewModel(16);

            //Hit Points 26	(4d8 + 8)
            if (GenerateStats)
            {
                HitPoints = new HitPointsViewModel(new Dice("4d8+8").Total, this);
            }
            else
            {
