...
public class Aasimar : HumanoidRace
{
    /// <summary>
    /// Create a new Aasimar humanoid 
    /// </summary>
    [SetsRequiredMembers]
    public Aasimar()
    {
...
//Size Medium  0
//Base Speed  Normal	0
//Ability Score Modifiers Flexible(+2 Wis, +2 Cha)   2
...
//Crusading Magic: Many aasimars feel obligated to train to defend the world against fiends. These aasimars gain a +2 racial bonus on caster level checks to overcome spell resistance and on Knowledge (planes) checks. This racial trait replaces the skilled and spell-like ability racial traits. Source PZO9280
...
//d6  Heritage Typical Alignment Ability Modifiers Alternate Skill Modifiers   Alternate Spell-Like Ability    Description
//1	Agathion-Blooded (Idyllkin) NG	+2 Con, +2 Cha Handle Animal, Survival summon nature’s ally II Idyllkin possess bestial aspects and calm dispositions, and often act as peaceful intermediaries between lawful and chaotic agents of good.
//2	Angel-Blooded (Angelkin) CG, NG, or LG	+2 Str, +2 Cha Heal, Knowledge (planes) alter self Angelkin are mortal paragons of exceptional beauty, and they serve as exemplars of good and light regardless of the myriad forms they may take.
//3	Archon-Blooded (Lawbringers) LG	+2 Con, +2 Wis Intimidate, Sense Motive    continual flame Lawbringers are champions of justice and of doling out punishment to the wicked, and often believe chaos is the cause of all mortal suffering.
//4	Azata-Blooded (Musetouched) CG	+2 Dex, +2 Cha Diplomacy, Perform glitterdust The musetouched epitomize freedom and joy, and travel the world to liberate less fortunate individuals.
//5	Garuda-Blooded (Plumekith) CG	+2 Dex, +2 Wis Acrobatics, Fly see invisibility Their shimmering avian features make plumekith instantly recognizable.Though they can act rashly, plumekith never shirk their duty after making a commitment.
//6	Peri-Blooded (Emberkin) NG	+2 Int, +2 Cha Knowledge (planes), Spellcraft pyrotechnics    Masters of fire magic, emberkin feel the dual pull of their peri forebear as well as that of a fallen angel further down their ancestry, and wrestle with their urges to do both good and evil.
...
//Celestial Servant
//Channel Force
//Channel Force, Greater
//Channel Force, Improved
