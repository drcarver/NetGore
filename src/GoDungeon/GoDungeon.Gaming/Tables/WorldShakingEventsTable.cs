    ...
    public class WorldShakingEventsTable : RandomTable, IWorldShakingEventsTable
    {
        ...
        public override void InitializeTable()
        {
            if (Table == null || Table.Count == 0)
            {
                ...
                {
                    #region Rise of a leader or an era
                    //1  Rise of a leader or an era
                    new RandomTableEntryViewModel
                    {
                        Range = new System.Range(01, 01),
                        Name = nameof(WorldShakingEventsEnum.RiseofaLeader),
                        Description = "Rise of a leader or an era"
                    },
                    #endregion
                };
            }
...
//pages of history. When they rise to power, they s hape
...
//Determine the kind of leader th at influences the new
...
//and messiahs, as well as those in cha rge of monasteries
...
//incidents; they're big events that unnatu ra lly alter
...
//omens. Describe the omen in detai l.
...
//6 New land(island, continent, lost wo rld, demiplane)
