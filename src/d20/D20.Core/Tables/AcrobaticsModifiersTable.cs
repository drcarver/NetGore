...
namespace D20.Core.Tables
{
    ...
    /// </summary>
    public class AcrobaticsModifiersTable : NamedTable, IAcrobaticsModifiersTable
    {
        /// <summary>
        /// Alignment Table
        /// </summary>
        public AcrobaticsModifiersTable()
        {
            Name = nameof(AcrobaticsModifiersTable);
        ...
        public override void InitializeTable()
        {
            if (Table.Count == 0)
            {
                Table = new List<IGameTableEntry>
                {
                    ...
                    //Lightly Obstructed(gravel, sand)   +2
                    new AcrobaticsModifiersTableEntry
                    {
