...
public static class ISpatialCollectionExtensions
{
    ...
    public static IEnumerable<ISpatial> GetMany(this ISpatialCollection c, ISpatial spatial, Predicate<ISpatial> condition) => c.GetMany(spatial.ToRectangle(), condition);
    ...
    /// <param name="spatial">The <see cref="ISpatial"/> representing the map area to check.</param>
    /// <returns>All <see cref="ISpatial"/>s found intersecting the given region.</returns>
    public static IEnumerable<ISpatial> GetMany(this ISpatialCollection c, ISpatial spatial) => c.GetMany(spatial.ToRectangle());
    ...
    public static IEnumerable<T> GetMany<T>(this ISpatialCollection c, ISpatial spatial, Predicate<T> condition) => c.GetMany(spatial.ToRectangle(), condition);
    ...
    /// <typeparam name="T">Type of ISpatial to convert to.</typeparam>
    /// <returns>List of all <see cref="ISpatial"/>s found intersecting the given region.</returns>
    public static IEnumerable<T> GetMany<T>(this ISpatialCollection c, ISpatial spatial) => c.GetMany<T>(spatial.ToRectangle());
}