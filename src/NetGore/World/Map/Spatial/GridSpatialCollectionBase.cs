...
/// </summary>
public abstract partial class GridSpatialCollectionBase : ISpatialCollection
{
    /// <summary>
    ...
    /// </summary>
    protected Point GridSize => _gridSize;
    ...
    protected virtual IGridSpatialCollectionSegment CreateSegment() => new CollectionSegment();
    ...
    protected IEnumerable<IGridSpatialCollectionSegment> GetSegments(ISpatial spatial) => GetSegments(spatial, spatial.Position);
    ...
    protected bool IsLegalGridSegment(Point gridIndex) => gridIndex.X >= 0 && gridIndex.Y >= 0 && gridIndex.X < GridSize.X && gridIndex.Y < GridSize.Y;
    ...
    protected Point WorldPositionToGridSegment(Vector2 worldPosition) => new Point((int)(worldPosition.X / _gridSegmentSize), (int)(worldPosition.Y / _gridSegmentSize));
