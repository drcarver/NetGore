...
public static class ISpatialExtensions
{
    ...
    public static int GetDistance(this ISpatial spatial, ISpatial other) => spatial.ToRectangle().GetDistance(other.ToRectangle());
    ...
    /// value will be 0. Otherwise, the value will be the length of the shortest path between the two
    /// <see cref="ISpatial"/>s.</returns>
    public static int GetDistance(this ISpatial spatial, Rectangle other) => spatial.ToRectangle().GetDistance(other);
    ...
    public static bool Intersects(this ISpatial a, ISpatial b)
    {
        ...
        a.ToRectangle().Intersects(ref bRect, out bool ret);
        return ret;
    }
}