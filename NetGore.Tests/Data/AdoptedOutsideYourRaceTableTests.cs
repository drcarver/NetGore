...
public class AdoptedOutsideYourRaceTableTests
{
    ...
    {
        var adoptedOutsideYourRaceTable = new AdoptedOutsideYourRaceTable();
        ClassicAssert.IsTrue(adoptedOutsideYourRaceTable.Name == nameof(AdoptedOutsideYourRaceTable));
        ClassicAssert.IsTrue(adoptedOutsideYourRaceTable.DiceSides == 100);

        for (int i = 1; i <= adoptedOutsideYourRaceTable.DiceSides; i++)
        {
            var entry = adoptedOutsideYourRaceTable.GetEntryByNumber(i);
