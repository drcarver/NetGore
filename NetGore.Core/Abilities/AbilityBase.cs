...
public abstract class AbilityBase : DataObject, IAbilityBase
{
    ...
    public List<ModifierTableEntry> ModifierTable { get; private set; } =
    [
        //1	-5	Can’t cast spells tied to this ability
        new ModifierTableEntry
        {
            Score = new Range(1, 1),
            Modifier = -5,
            BonusSpells = null,
    ...
    public ModifierTableEntry GetModifier()
    {
    ...
    [SetsRequiredMembers]
    public AbilityBase(ILogger? logger, ICreature creature)
        : this(creature)
    {
        Logger = logger;
    }
    ...
    public AbilityBase(ICreature creature)
    {
        ...
        CreatureId = ((IBaseObject) creature).Id;
    }
