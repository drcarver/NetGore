...
public class CharacterTemplate : BaseObject, ICharacterTemplate
{
    ...
    [Comment("The AI (intended for NPCs only).")]
    ...
    [Comment("The chat dialog (intended for NPCs only).")]
    ...
    [Comment("Amount of cash to give when killed (intended for NPCs only).")]
    ...
    [Comment("Amount of exp to give when killed (intended for NPCs only).")]
    ...
    [Comment("The shop (intended for NPCs only).")]
    ...
    [Comment("Number of stat points available to spend.")]
