    ...
    public CharacterDrawbackTable()
    {
        ...
        [
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Justice",
                Description =
                    "Unfairness and injustice are " +
                    "intolerable. Whenever you witness " +
                    "them, you feel compelled to act " +
                    "or speak out. When you’re personally " +
                    "wronged, you require appeasement—or " +
                    "revenge if you don’t receive it. You " +
                    "gain access to the Headstrong drawback.",
                Traits =
                {
                    TraitEnum.Headstrong
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Love",
                Description =
                    "Your love for someone motivates " +
                    "you. When this person is in " +
                    "danger, you’re prone to feel " +
                    "weak, powerless, or angry. You " +
                    "gain access to the Lovesick " +
                    "drawback.",
                Traits =
                {
                    TraitEnum.Lovesick
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Loyalty",
                Description =
                    "You value loyalty over all things. " +
                    "You treasure the friends, associates, " +
                    "and lovers you have earned throughout " +
                    "the years, and when someone breaks " +
                    "your trust or betrays you in some " +
                    "way, you become utterly unhinged. " +
                    "You gain access to the Pride drawback.",
                Traits =
                {
                    TraitEnum.Pride
                },
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Material Wealth",
                Description =
                    "You have a weakness for material " +
                    "things—money, fine jewelry, " +
                    "exquisite foods, expensive or " +
                    "rare items, and so on. When such " +
                    "riches are within your reach, " +
                    "you’re driven to possess them, " +
                    "and you claim them either as an " +
                    "honest collector or a cunning " +
                    "thief. You gain access to the " +
                    "Avarice drawback.",
                Traits =
                {
                    TraitEnum.Avarice
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Pleasure",
                Description =
                    "You crave luxury, entertainment, " +
                    "and pleasure. You might indulge " +
                    "in every passing fancy or hold " +
                    "strong against a temptation that " +
                    "constantly eats at you. You gain " +
                    "access to the Hedonistic drawback.",
                Traits =
                {
                    TraitEnum.Hedonistic
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Power",
                Description =
                    "You long for the ability to " +
                    "influence the world around you, " +
                    "whether that’s as small as a " +
                    "village or as large as a plane " +
                    "of reality. You gain access to " +
                    "the Power-Hungry drawback.",
                Traits =
                {
                    TraitEnum.PowerHungry
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Pride",
                Description =
                    "You present an image to the world " +
                    "that can’t be tarnished. When " +
                    "someone questions your motives, " +
                    "criticizes your actions, or insults " +
                    "your honor or pride, you question " +
                    "his friendship or count him among " +
                    "your enemies until he makes amends. " +
                    "You gain access to the Pride drawback.",
                Traits =
                {
                    TraitEnum.Pride
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Race",
                Description =
                    "You are truly comfortable only " +
                    "around others of your race, and " +
                    "you have a hard time putting " +
                    "faith or trust in those of races " +
                    "different from your own. You " +
                    "gain access to the Xenophobic drawback.",
                Traits =
                {
                    TraitEnum.Xenophobic
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Religion",
                Description =
                    "Your beliefs are of paramount " +
                    "importance in your life, whether " +
                    "you belong to a temple, follow " +
                    "a cult, or practice a religious " +
                    "philosophy independently. When " +
                    "others question or attack the " +
                    "beliefs, principles, relics, or " +
                    "structures of your faith, you " +
                    "respond with fury. You gain " +
                    "access to the Zealous drawback.",
                Traits =
                {
                    TraitEnum.Zealous
                },
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Reputation or Fame",
                Description =
                    "You’ve worked hard to establish " +
                    "your identity and reputation, " +
                    "and someone who slanders or " +
                    "insults you must answer for it. " +
                    "You strive to promote your " +
                    "identity to the point where " +
                    "everyone knows your reputation. " +
                    "You gain access to the Vain " +
                    "drawback.",
                Traits =
                {
                    TraitEnum.Vain
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Safety or Security",
                Description =
                    "You are cautious and guarded—wary " +
                    "of others who might harm you, " +
                    "steal from you, or betray your " +
                    "trust. As such, you sleep lightly, " +
                    "always suspecting someone or " +
                    "something to sneak in upon you " +
                    "in the dark. Even when in " +
                    "relationships with people who " +
                    "trust you, there’s always the " +
                    "fear that they harbor hidden agendas " +
                    "or will change and turn against you. " +
                    "You gain access to the Paranoid drawback.",
                Traits =
                {
                    TraitEnum.Paranoid
                },
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Self-Doubt",
                Description =
                    "No matter what you do, it’s never " +
                    "good enough. You cannot help but " +
                    "see in your victories many little " +
                    "defeats and failures. If you were " +
                    "stronger, smarter, faster, or more " +
                    "powerful, maybe you could be " +
                    "better. However, stuck in the body " +
                    "and mind you have, you feel you’re " +
                    "destined to fail. You gain access " +
                    "to the Doubt drawback.",
                Traits =
                {
                    TraitEnum.Doubt
                },
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Social Acceptance",
                Description =
                    "You want others to accept you, " +
                    "to believe you’re special and " +
                    "worthy of merit. You are " +
                    "self-conscious about your social " +
                    "flaws and breaches of etiquette. " +
                    "Rejection is among your greatest " +
                    "fears. You might go to " +
                    "extraordinary lengths to be " +
                    "accepted by or seek favor from " +
                    "your peers. You gain access to " +
                    "the Dependent drawback.",
                Traits =
                {
                    TraitEnum.Dependent
                },
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "The Future",
                Description =
                    "Your concerns lie not with the " +
                    "present, but with preparation " +
                    "for the future. You may be an " +
                    "avid and organized planner, " +
                    "or perhaps you see the signs " +
                    "of a coming dark age or troubled " +
                    "time. You behave cautiously, " +
                    "conservatively, and methodically " +
                    "as you plan for events that might " +
                    "one day occur. You gain access " +
                    "to the Meticulous drawback.",
                Traits =
                {
                    TraitEnum.Meticulous
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "The Past",
                Description =
                    "You long for the world to return " +
                    "to a past age. You’ve adopted the " +
                    "manners and style of this age, and " +
                    "are fascinated by its customs, " +
                    "relics, and artifacts, and by " +
                    "the historical figures of that " +
                    "time. Perhaps you live so much in " +
                    "this past age that your connection " +
                    "to the present is tenuous. Or your " +
                    "pretentiousness annoys others. " +
                    "You gain access to the Sentimental drawback.",
                Traits =
                {
                    TraitEnum.Sentimental
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Worldview",
                Description =
                    "In your eyes, your moral " +
                    "philosophy—your alignment—is " +
                    "the only correct and true way " +
                    "of the world. Perhaps you gently " +
                    "pity, argue with, or brawl with " +
                    "those misguided souls who don’t " +
                    "see the world your way or by your " +
                    "light of reason. You gain access " +
                    "to the Provincial drawback.",
                Traits =
                {
                    TraitEnum.Provincial
                },
            },
            #endregion
            ...
            new RandomTableRangeEntry
            {
                ...
                ProperName = "Youth",
                Description =
                    "Youth You reflect upon your " +
                    "youth as a golden time, one " +
                    "ever present in your mind and " +
                    "that refuses to fade into the " +
                    "background. Every day, you feel " +
                    "yourself growing older and " +
                    "closer to your inevitable end. " +
                    "You seek ways to make yourself " +
                    "look and feel young in attempt " +
                    "to rekindle that fire of your " +
                    "adolescence, but despite your " +
                    "attempts, you realize that your " +
                    "time still draws ever nearer. " +
                    "You gain access to the Vain drawback.",
                Traits =
                {
                    TraitEnum.Vain
                },
