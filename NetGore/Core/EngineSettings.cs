...
public class EngineSettings
{
    ...
    /// volume for sounds that exceed the <see cref="SoundMinDistance"/>.
    /// </summary>
    ...
    /// <see cref="Initialize"/>. After being set, this value is guaranteed to contain
    /// the same <see cref="EngineSettings"/> reference.
    /// </summary>
    public static EngineSettings Instance => _instance;
