...
public class LinearSpatialCollection : ISpatialCollection
{
    ...
    public void Add(ISpatial spatial) => _spatials.Add(spatial);
    ...
    /// otherwise false.
    /// </returns>
    public bool CollectionContains(ISpatial spatial) => _spatials.Contains(spatial);
    ...
    public bool Contains<T>(Vector2 point) => Contains<T>(point, x => true);
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains(Vector2 point) => Contains(point, x => true);
    ...
    public bool Contains<T>(Predicate<T> condition) => _spatials.OfType<T>().Any(x => condition(x));
    ...
    /// <param name="condition">The additional condition an <see cref="ISpatial"/> must match to be included.</param>
    /// <returns>True if the specified area or location contains any spatials; otherwise false.</returns>
    public bool Contains(Predicate<ISpatial> condition) => _spatials.Any(x => condition(x));
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains<T>(Vector2 point, Predicate<T> condition) => _spatials.Any(x => x is T && x.Contains(point) && condition((T)x));
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains<T>(Rectangle rect, Predicate<T> condition) => _spatials.Any(x => x is T && x.Intersects(rect) && condition((T)x));
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains(Vector2 point, Predicate<ISpatial> condition) => Contains<ISpatial>(point, condition);
    ...
    /// </returns>
    [SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter")]
    public bool Contains<T>(Rectangle rect) => Contains<T>(rect, x => true);
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains(Rectangle rect) => Contains(rect, x => true);
    ...
    /// True if the specified area or location contains any spatials; otherwise false.
    /// </returns>
    public bool Contains(Rectangle rect, Predicate<ISpatial> condition) => Contains<ISpatial>(rect, condition);
    ...
    /// </returns>
    public T Get<T>(Rectangle rect, Predicate<T> condition) => GetMany(rect, condition).FirstOrDefault();
    ...
    /// The first <see cref="ISpatial"/> found in the given region, or null if none found.
    /// </returns>
    public ISpatial Get(Rectangle rect, Predicate<ISpatial> condition) => Get<ISpatial>(rect, condition);
    ...
    /// </returns>
    public T? Get<T>(Vector2 p, Predicate<T> condition) => GetMany(p, condition).FirstOrDefault();
    ...
    /// First <see cref="ISpatial"/> found at the given point, or null if none found.
    /// </returns>
    public ISpatial Get(Vector2 p) => Get<ISpatial>(p);
    ...
    /// First <see cref="ISpatial"/> found at the given point, or null if none found.
    /// </returns>
    public ISpatial Get(Vector2 p, Predicate<ISpatial> condition) => Get<ISpatial>(p, condition);
    ...
    /// </returns>
    public ISpatial Get(Rectangle rect) => Get<ISpatial>(rect);
    ...
    /// First ISpatial found at the given point, or null if none found
    /// </returns>
    public T Get<T>(Rectangle rect) => Get<T>(rect, x => true);
    ...
    public T Get<T>(Predicate<T> condition) => _spatials.OfType<T>().FirstOrDefault(x => condition(x));
    ...
    /// <param name="condition">Condition the <see cref="ISpatial"/> must meet.</param>
    /// <returns>First <see cref="ISpatial"/> matching the given condition, or null if none found.</returns>
    public ISpatial Get(Predicate<ISpatial> condition) => _spatials.FirstOrDefault(x => condition(x));
    ...
    public IEnumerable<ISpatial> GetMany(Vector2 p) => GetMany<ISpatial>(p);
    ...
    /// </returns>
    public IEnumerable<ISpatial> GetMany(Rectangle rect) => GetMany<ISpatial>(rect);
    ...
    /// </returns>
    public IEnumerable<T> GetMany<T>(Vector2 p) => GetMany<T>(p, x => true);
    ...
    /// All <see cref="ISpatial"/>s found intersecting the given region.
    /// </returns>
    public IEnumerable<T> GetMany<T>(Rectangle rect) => GetMany<T>(rect, x => true);
    ...
    /// </returns>
    public IEnumerable<T> GetMany<T>() => _spatials.OfType<T>().ToImmutable();
    ...
    /// <param name="condition">The additional condition an <see cref="ISpatial"/> must match to be included.</param>
    /// <returns>All of the spatials at the given point.</returns>
    public IEnumerable<ISpatial> GetMany(Vector2 p, Predicate<ISpatial> condition) => GetMany<ISpatial>(p, condition);
    ...
    /// <returns>All of the spatials at the given point.</returns>
    public IEnumerable<ISpatial> GetMany(Predicate<ISpatial> condition) => _spatials.Where(x => condition(x)).ToImmutable();
    ...
    /// <param name="condition">The condition an <see cref="ISpatial"/> must match to be included.</param>
    /// <returns>All of the spatials at the given point.</returns>
    public IEnumerable<T> GetMany<T>(Predicate<T> condition) => _spatials.OfType<T>().Where(x => condition(x)).ToImmutable();
    ...
    /// All <see cref="ISpatial"/>s found intersecting the given region.
    /// </returns>
    public IEnumerable<T> GetMany<T>(Rectangle rect, Predicate<T> condition) => _spatials.Where(x => x is T && x.Intersects(rect) && condition((T)x)).OfType<T>().ToImmutable();
    ...
    /// All spatials containing the given point that are of the given type.
    /// </returns>
    public IEnumerable<T> GetMany<T>(Vector2 p, Predicate<T> condition) => _spatials.Where(x => x is T && x.Contains(p) && condition((T)x)).OfType<T>().ToImmutable();
    ...
    /// All <see cref="ISpatial"/>s found intersecting the given region.
    /// </returns>
    public IEnumerable<ISpatial> GetMany(Rectangle rect, Predicate<ISpatial> condition) => GetMany<ISpatial>(rect, condition);

    /// <summary>
    /// Removes an <see cref="ISpatial"/> from the spatial collection.
    /// </summary>
    /// <param name="spatial">The <see cref="ISpatial"/> to remove.</param>
    public void Remove(ISpatial spatial) => _spatials.Remove(spatial);
